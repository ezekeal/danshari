...
def generate_pages_recursively(
    ...
    generate_files_in_dir(dir_path_content, template_path, dest_dir_path, basepath)


def generate_files_in_dir(dir_path_content, template_path, dest_dir_path, basepath):
    ...
    for dir in dirs:
        ...
        generate_files_in_dir(new_content_path, template_path, new_dest_path, basepath)
